        ...
        for item in menu:
            if item['id'] == id_menu:
                ...
                bayar.append({
                    ...
                    "nama": nama, "meja": id_meja
                })
                tabel = PrettyTable(['Nama', 'Nomor Meja', 'Menu', 'Jumlah', 'Total'])
                tabel.add_row([nama, id_meja, item['menu'], jumlah, total])
                print(tabel)
                return
...
def lihat_transaksi():
    if bayar:
        tabel = PrettyTable(['Nama', 'Meja', 'Menu', 'Jumlah', 'Total'])
        for t in bayar:
            tabel.add_row([t['nama'], t['meja'], t['menu'], t['jumlah'], t['total']])
        print(tabel)
    else:
